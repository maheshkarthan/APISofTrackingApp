...
<script src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
    ...
    function mobileValidateCall() {
    	...
    	// get the form values
    	        ...
    	        $.ajax({
    	        type: "GET",
    	        url: path+"/usermobileverify.html",
...
<div class="row" align="center">
 ...
 <form method="POST" onsubmit="return getValidation()" action="registeruser.html"> 

<table class="table">
			    <tr>
			        <td align="right"><label>Mobile No:</label></td>
			        <td><input type="text" name="mobile" onfocusout="mobileValidateCall()" id="mobile" maxlength="10" onkeypress="return isNumberKey(event);" value=""/><!--<font color="red"><p id="availability"></p></font></td>   -->
			    </tr>
			    <tr>
...
<a href="registeruserdetails.html">User Details</a>
